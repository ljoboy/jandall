package org.alljo.jandall.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, org.alljo.jandall.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, org.alljo.jandall.repository.UserRepository.USERS_BY_EMAIL_CACHE);
